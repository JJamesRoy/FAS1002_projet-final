...
```{r}
mod2 = lm(renewables_energy_per_capita ~ gdp, data = dat_full, na.action=na.exclude)

mod2 = lm(renewables_electricity ~ gdp_per_capita, data = dat_full, na.action=na.exclude)

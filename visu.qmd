...
dat_map = dat_map %>% pivot_longer(!country, names_to = "year", values_to = "electricity_generation") %>% filter(year == 2019) %>% mutate(iso = countrycode(country, "country.name", "iso3c"))
